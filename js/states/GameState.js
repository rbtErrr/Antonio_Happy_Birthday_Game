...
SpaceFighter.GameState = {
    ...
    preload: function () {
        ...
        this.load.image('blackEnemy', 'assets/images/enemyFat_2.png');
        //this.load.image('redEnemy', 'assets/images/enemyRed4.png');
        this.load.image('redEnemy', 'assets/images/enemyFat.png');
        //this.load.image('greenEnemy', 'assets/images/enemyGreen1.png');
        this.load.image('greenEnemy', 'assets/images/enemyFat_3.png');
